...
outdir = './outdir/'
infile = outdir + 'parceltime.dat'

tcolumns = ['tc','zalt','temp','press', 'qvap','qliq','qice','RH', 'Ntot', 'Nctot', 'ravg', 'rcavg']
...
ax6.plot(datas['tc'],datas['rcavg'],linestyle = '-', color = 'k')
...
ax5.plot(datas['Ntot'],datas['zalt'],linestyle = '--', color = 'k',label='total')
